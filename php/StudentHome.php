    ...
    <div class="container-fluid">
        <div class="row">
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <div class="row gy-3 gx-5">
                                    ...
                                    <div class="col-9">
                                        <div class="p-3">
                                            <a class="p1" href="/php/StudentReqt.php">Request</a>
                                        </div>
                                    </div>
                                </div>
                                <hr />
            ...
            <div class="col-xl-9 RightColMain">
                ...
                <br><br>
                <h5 class="text-center ">Attendance Request</h5>
                ...
                <?php } ?>
                <form action="/StudentHomeInsert.php" method="post" class="p-5">
                    <div class="row mb-4">
                        <div class="col-6 gx-5">
                            ...
                            ?>
                            <label for="Select" class="form-label">Course Name</label>
                            <select name="CourseName" id="Select" class="form-select">
                                <?php
...
?>
                        ...
                        <div class="col-6 gx-5">
                            ...
                            <br>
                            <input type="date" id="meeting-time" name="DateTime" class="form-control">
                    ...
                    <div class="row my-2">
                        <div class="col-6 gx-5">
                            <label for="Select" class="form-label">To be approved by: </label>
                            <select name="facName" id="Select" class="form-select">
                                <?php
...
?>
                    ...
                    <div class="col-12 text-center">
                        <input class="btn btn-light submitBtn" name="submit" type="submit" value="Request">
                    </div>
                </form>
            </div>
        </div>
