                ...
                <div class="container text-center">
                    <div class="row">
                        <div class="col-4" id="colBg2">
                            <a href="/php/FacultyInsert.php"><button type="button" class="btn roundBtn">Add new
                                    faculty</button></a>
                        </div>
                        <div class="col-4" id="colBg2">
                            <a href="/php/StudentInsert.php"><button type="button" class="btn roundBtn">Add new
                                    student</button></a>
                        </div>
                        <div class="col-4" id="colBg2">
                            <a href="/php/CourseInsert.php"><button type="button" class="btn roundBtn">Add new
                                    course</button></a>
                        </div>
                    </div>
                </div>
