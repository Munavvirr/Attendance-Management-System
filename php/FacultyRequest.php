                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item active">
                                <div class="row gy-3 gx-5">
                                    ...
                                    <div class="col-9">
                                        <div class="p-3">
                                            <a class="p1" href="/FacultyRequest.php">Requests</a>
                                        </div>
                                    </div>
                                </div>
                                <hr />
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php
                            $query = "SELECT studenthome.id,reqt.rid,studenthome.name,studenthome.DateTime,studenthome.Reason from reqt, studenthome where reqt.fid='$fid' and reqt.rid = studenthome.rid and status= 'pending'";
                            $result = mysqli_query($conn, $query);
                            if (!empty(mysqli_num_rows($result))) {
                              while ($row = mysqli_fetch_assoc($result)) { ?>
                            <td> <?php echo $row["id"]; $rid = $row['rid']?></td>
                            ...
                            <td>
                                ...
                                $sql = "SELECT course.name FROM reqt,studenthome,course WHERE reqt.rid = '$rid' AND reqt.rid=studenthome.rid AND studenthome.CourseName = course.course_name";
                            ...
                            <td>
                                <form action="FRA.php" method="post">
